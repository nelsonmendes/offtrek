    ...
    $.fn.calendar = function(options) {
        ...
        this.each(function(){
            ...
            function showCalendar(){
                ...
                var btnNextMonth = $('<td><span class="glyphicon glyphicon-chevron-right"></span></td>');
                ...
                var btnPrevMonth = $('<td><span class="glyphicon glyphicon-chevron-left"></span></td>');
                ...
                $('.glyphicon glyphicon-chevron-left').css('cursor', 'pointer');
                $('.glyphicon glyphicon-chevron-right').css('cursor', 'pointer');
